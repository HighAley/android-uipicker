...
public class UiPickerView extends Button {
	...
	public void initStyleButton(AttributeSet attrs){
		 ...
		 mEnumValue=mTypedArray.getInt(R.styleable.UiPickerView_pickerType,2);
		 mTypedArray.recycle();
	}
		...
		this.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				case 0: //none type 
					...
					case 2:		DialogUtil.showTimeDialog(mContext, mButtonTextColor, mTitleTextColor, mTitleBGColor, mSelectedItemTextColor, mItemTextColor, mPickerBGColor, mPickerBGDrawable, mType,null, new DialogUtil.CalendarDialogListener() {
